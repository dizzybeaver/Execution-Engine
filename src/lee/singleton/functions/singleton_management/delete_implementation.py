"""singleton/functions/singleton_management/delete_implementation.py
Version: 2025.12.13.01
Description: Delete singleton implementation function
...
def delete_implementation(name: str, correlation_id: str = None, **kwargs) -> bool:
    ...
    return manager.delete(name, correlation_id=correlation_id, **kwargs)


__all__ = ["delete_implementation"]
