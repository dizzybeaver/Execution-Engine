"""
Memcached Interface Router - Networking Domain
...
from EE.networking.protocols.memcached.memcached_factory import MemcachedFactory


def execute_memcached_operation(operation: str, **kwargs) -> Any:
    """
    Execute Memcached operation (Router Interface).
    ...
    Args:
        operation: Operation name (get, set, add, replace, delete, increment, decrement, flush, stats)
    ...
    if not handler:
        raise ValueError(
            f"Unknown Memcached operation: {operation}. "
