"""
NTP Interface Router - Networking Domain
...
from EE.networking.protocols.ntp.ntp_factory import NTPFactory


def execute_ntp_operation(operation: str, **kwargs) -> Any:
    """
    Execute NTP operation (Router Interface).
    ...
    Args:
        operation: Operation name (get_time, sync)
    ...
    if not handler:
        raise ValueError(
            f"Unknown NTP operation: {operation}. "
