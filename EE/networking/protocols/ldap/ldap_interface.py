"""
LDAP Interface Router - Networking Domain
...
from EE.networking.protocols.ldap.ldap_factory import LDAPFactory


def execute_ldap_operation(operation: str, **kwargs) -> Any:
    """
    Execute LDAP operation (Router Interface).
    ...
    Args:
        operation: Operation name (connect, bind, unbind, search, disconnect)
    ...
    if not handler:
        raise ValueError(
            f"Unknown LDAP operation: {operation}. "
