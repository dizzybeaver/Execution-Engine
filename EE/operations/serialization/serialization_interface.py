"""
Serialization Interface Router - Operations Domain
...
def execute_serialization_operation(operation: str, **kwargs) -> Any:
    """
    Execute serialization operation (Router Interface).
    ...
    Args:
        operation: Operation name (to_json, from_json, to_pickle, from_pickle)
    ...
    _DISPATCH = {
        'to_json': factory.to_json,
        'from_json': factory.from_json,
        'to_pickle': factory.to_pickle,
        'from_pickle': factory.from_pickle,
    }
    ...
    if not handler:
        raise ValueError(
            f"Unknown serialization operation: {operation}. "
